...
class ProductStockLocationTest {
    ...
    public void create_withMultipleStockLocations_persistsEachLocation() {
        Product product = new Product("Warehouse Widget", "d", new Money(new BigDecimal("10.00"), "BRL"),
                List.of(
                        new StockLocation("WAREHOUSE-SP", 20, 5),
                        new StockLocation("WAREHOUSE-RJ", 10, 0)
                ), newCategoryId());
    ...
    public void create_reservedExceedsOnHand_returnsBadRequest() {
        Product product = new Product("Overbooked Widget", "d", new Money(new BigDecimal("10.00"), "BRL"),
                List.of(new StockLocation("WAREHOUSE-SP", 5, 10)), newCategoryId());
    ...
    public void create_withNoStockLocations_returnsBadRequest() {
        Product product = new Product("No Stock Widget", "d", new Money(new BigDecimal("10.00"), "BRL"),
    ...
    public void totalOnHandReservedAndAvailable_sumAcrossLocations() {
        Product product = new Product("Aggregate Widget", "d", new Money(new BigDecimal("10.00"), "BRL"),
                List.of(
                        new StockLocation("WAREHOUSE-SP", 20, 5),
                        new StockLocation("WAREHOUSE-RJ", 10, 2)
                ), newCategoryId());
